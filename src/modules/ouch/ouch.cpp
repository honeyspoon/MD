...
enum class liquidity_flag_t : char {
  ...
  RETAIL_ORDER_REMOVES_PRICE_IMPROVING_NON_DISPLAYED_LIQUIDITY_OTHER_THAN_RPI_LIQUIDITY =
      't',
...
constexpr msg_length_t MAX_MSG_LENGTH = sizeof(replaced_message_t);
...
void hn_swap(system_event_message_t &msg) {
  hn_swap(msg.header);
}

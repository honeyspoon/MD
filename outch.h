...
static_assert(sizeof(packet_header_t) == 6, "packet_header struct size mismatch");
...
static_assert(sizeof(msg_header_t) == 12, "packet type struct size mismatch");
...
static_assert(sizeof(executed_message_t) == 43, "Executed Message struct size mismatch");
